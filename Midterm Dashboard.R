...
ggplot(country_map_scores_rla) +
  ...
  coord_map() +
  theme_map() +
  labs(title = "Reading and Language Arts Proficiency in the US in 2020-2021 above or equal to 35",
...
ggplot(map_math) +
  ...
  coord_map() +
  theme_map() +
  labs(title = "Math Proficiency in the US in 2020-2021 above or equal to 35",
       subtitle = "States scoring a 35 or above are highlighted in Red, below in Blue.",
